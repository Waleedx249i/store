                        ...
                        <a class="" href="#">
                            <button
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512"
                                    aria-hidden="true"
                                    class="w-5 h-5 text-inherit"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            ...
            <div class="mt-12">
                <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                        ...
                        <div class="border-t border-blue-gray-50 p-4">
                            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                                <strong class="text-red-500">-3%</strong>&nbsp;than last month
                            </p>
                        </div>
...
export default {
    ...
    methods: {
        ...
        loadData: function () {
            axios.get('http://127.0.0.1:8001/api/dashbord').then((response) => {
                this.userscont = response.data.data.userscont;
                this.orderCont = response.data.data.orderCont;
                this.unpaidOrders = response.data.data.unpaidOrders;
                this.totalSaels = response.data.data.totalSaels;
            }).catch(function (error) {
                console.log(error);
            });
        },
        loadorders: function () {
            axios.get('http://127.0.0.1:8001/api/dashbord/orders').then((response) => {
                this.orders = response.data.ordrs;
